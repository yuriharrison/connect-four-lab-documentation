<span style="float:right;">[[source code]](https://github.com/yuriharrison/connect-four-lab/blob/master/connectFourLab/app/myWidgets/confirmationPopUp.py#L46)</span>
## ConfirmationPopup
